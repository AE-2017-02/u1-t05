...
<html>
    <head>
        ...
        <%
            System.out.println("calculadora" + request.getParameter("calc"));
            System.out.println("computadora" + request.getParameter("comp"));
            System.out.println("monitor" + request.getParameter("monit"));
            System.out.println("teclaro" + request.getParameter("tecl"));
            System.out.println("mous" + request.getParameter("mous"));
